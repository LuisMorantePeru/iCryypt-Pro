...
//18: Crear el archivo llamado Endpoint , ahi se condfigura de qué forma llega Json al app
enum Endpoint {
    case fetchCoins(url: String = "/v1/cryptocurrency/listings/latest")
    
    var request : URLRequest? {
        //evaluar si la url es opcional
...
//19: Obtener los datos de la URL y convertir los datos JSON
